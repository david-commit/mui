...
const rightSideBar = () => {
  return (
    <section className='w-[600px] sticky hidden top-2 overflow-y-auto mt-2 xl:flex flex-col items-stretch h-[90vh] overflow-x-hidden px-6'>
      <div>
      ...
      <div className='flex flex-col rounded-xl bg-neutral-900  my-4'>
        <h3 className='font-bold text-l mt-4 px-4'>What’s happening</h3>
        <div>
          {Array.from({ length: 5 }).map((_, i) => (
            ...
            >
              <div className='font-bold text-g '>#trending{i + 1}</div>
      ...
      <div className='flex flex-col rounded-xl bg-neutral-900 my-4'>
        <h3 className='font-bold text-l my-4 px-4'>Who to follow</h3>
        <div>
